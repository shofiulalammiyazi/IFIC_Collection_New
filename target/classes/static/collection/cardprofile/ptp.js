...
// $("#tab-Card-ptp").click(function (event) {
        ...
        success: function (data) {
            ...
            for(var i=0;i<data.ptp.length;i++){
                if (data.ptp[i]!=null){
                    ...
                    let b = date >= date1;
                    if(b){
                        str1 = "<a style=\"margin-bottom:2px\" class=\"btn btn-xs btn-info\" onclick=\"card_ptp_editRow(this,"+data.ptp[i].card_contact_details_id+","+data.ptp[i].card_contact_location_id+","+data.ptp[i].card_promisor_details_id+")\"> <i class=\"fa fa-edit\"></i></a>"
                    ...
                    var str="<tr>"+
                        ...
                        "<td>" + data.ptp[i].username + '-' + data.ptp[i].pin + "</td>" +
                        ...
                        "<td>" + data.ptp[i].card_remarks + "</td>" +
                        "<td>" + data.ptp[i].card_ptp_status + "</td>" +
                        "<td>"+ str2 + str1 + "<a  class=\"btn btn-xs btn-info\" onclick=\"card_ptp_viewRow(this)\"> <i class=\"fa fa-eye\"></i></a>"+"</td>" +
                        "</tr>";
...
function card_ptp_viewRow(node) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#card_ptp_remark_view").text(data.cardptplist.card_remarks);
