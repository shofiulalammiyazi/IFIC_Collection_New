...
function checkLimit(div_id,limit) {
    var data, limit;
    data = document.getElementById(div_id);
    data.value.toString();
    ...
    if( data > limit ) {
        document.getElementById(div_id).value = limit;
    }
}
...
function amountToWords(amount) {
    ...
    if( words_string.length == 0 ) { words_string = "Zero" ; }
