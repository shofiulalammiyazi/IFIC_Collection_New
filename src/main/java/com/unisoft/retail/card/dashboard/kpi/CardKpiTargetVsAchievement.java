package com.unisoft.retail.card.dashboard.kpi;
...
@Data
@Entity
public class CardKpiTargetVsAchievement {
    @Id
    ...
    public CardKpiTargetVsAchievement() {
    }
    
    public CardKpiTargetVsAchievement(Tuple data) {
        dealerPin = Objects.toString(data.get("DEALER_PIN"), "");
        productGroup = Objects.toString(data.get("PRODUCT"), "");
        dpdBucket = Objects.toString(data.get("AGE_CODE"), "");
