...
@RequestMapping("/legal/report/managerial/statement-of-high-court-cases")
public class StatementOfHighCourtCasesController {

    private final CaseTypeService caseTypeService;
    private final StatementOfHighCourtCasesService service;
    private final JasperReportManager jasperReportManager;
    
    @Value("")
    private String jasperFile;
    
    @Value("Statement Of High Court Cases")
    private String reportTitle;

    @GetMapping("/view")
    public String view(Model model) {
        model.addAttribute("caseTypes", caseTypeService.findByCaseFiledSubTypeName("High Court Division"));
        model.addAttribute("reportTitle", "Statement Of High Court Cases");
        return "legal/report/managerial/statementOfHighCourtCases/view";
    }

    @GetMapping("/report")
    @ResponseBody
    public Map<String, List<StatementOfHighCourtCasesDto>> getReport(Long[] caseTypes, String byWhomeFiled, String startDate, String endDate) {
