...
@Data
public class LegalCourseOfActionReportDto {

    private Object courseOfActionName;
    ...
    LegalCourseOfActionReportDto() {

    }

    LegalCourseOfActionReportDto(String nameOfReport) {
