...
import com.csinfotechbd.collection.samd.setup.bBAuditType.BBAuditType;
import com.csinfotechbd.collection.samd.setup.bBAuditType.BBAuditTypeService;
import com.csinfotechbd.collection.samd.setup.bbcommentsforclassification.BbCommentsForClassification;
import com.csinfotechbd.collection.samd.setup.bbcommentsforclassification.BbCommentsForClassificationService;
import com.csinfotechbd.collection.samd.setup.borrowerGuarantorsCapabilityToRepay.BorrowerGuarantorCapabilityRepay;
import com.csinfotechbd.collection.samd.setup.borrowerGuarantorsCapabilityToRepay.BorrowerGuarantorCapabilityRepayService;
import com.csinfotechbd.collection.samd.setup.borrowerPresentStatus.BorrowerPresentStatus;
import com.csinfotechbd.collection.samd.setup.borrowerPresentStatus.BorrowerPresentStatusService;
import com.csinfotechbd.collection.samd.setup.borrowerbusinessstatus.BorrowerBusinessStatus;
import com.csinfotechbd.collection.samd.setup.borrowerbusinessstatus.BorrowerBusinessStatusService;
import com.csinfotechbd.collection.samd.setup.borrowerguarantoravailability.BorrowerAndGuarantorAvailability;
import com.csinfotechbd.collection.samd.setup.borrowerguarantoravailability.BorrowerAndGuarantorAvailabilityService;
import com.csinfotechbd.collection.samd.setup.borrowerstayingat.BorrowerStaying;
import com.csinfotechbd.collection.samd.setup.borrowerstayingat.BorrowerStayingService;
import com.csinfotechbd.collection.samd.setup.capableInfluenceCustomerBankDue.CapableInfluenceCustomerBankDue;
import com.csinfotechbd.collection.samd.setup.capableInfluenceCustomerBankDue.CapableInfluenceCustomerBankDueService;
import com.csinfotechbd.collection.samd.setup.categoryForDelinquency.CategoryDelinquency;
import com.csinfotechbd.collection.samd.setup.categoryForDelinquency.CategoryForDelinquencyService;
import com.csinfotechbd.collection.samd.setup.interestedFurtherLoan.InterestedFurtherLoan;
import com.csinfotechbd.collection.samd.setup.interestedFurtherLoan.InterestedFurtherLoanService;
...
import com.csinfotechbd.collection.samd.setup.logicInTerms.LogicInTerms;
import com.csinfotechbd.collection.samd.setup.logicInTerms.LogicInTermsService;
import com.csinfotechbd.collection.samd.setup.possibilityprobabilitytohitinnplUnclassified.PossibilityProbability;
import com.csinfotechbd.collection.samd.setup.possibilityprobabilitytohitinnplUnclassified.PossibilityProbabilityService;
import com.csinfotechbd.collection.samd.setup.possibilityprobabilitytohitinnplclassified.PossibilityProbabilityClassified;
import com.csinfotechbd.collection.samd.setup.possibilityprobabilitytohitinnplclassified.PossibilityProbabilityClassifiedService;
import com.csinfotechbd.collection.samd.setup.sourceOfRecovery.SourceOfRecovery;
import com.csinfotechbd.collection.samd.setup.sourceOfRecovery.SourceOfRecoveryService;
import com.csinfotechbd.collection.samd.setup.sourceofrecoverytools.SourceOfRecoveryTools;
import com.csinfotechbd.collection.samd.setup.sourceofrecoverytools.SourceOfRecoveryToolsService;
import com.csinfotechbd.collection.samd.setup.wayForwardReduceFromNPL.WayForwardReduceFromNPL;
import com.csinfotechbd.collection.samd.setup.wayForwardReduceFromNPL.WayForwardReduceFromNPLService;
import com.csinfotechbd.collection.samd.setup.whethertheloanistetd.WhetherTheLoanTeTdRcRs;
import com.csinfotechbd.collection.samd.setup.whethertheloanistetd.WhetherTheLoanTeTdRcRsService;
