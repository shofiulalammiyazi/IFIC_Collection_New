...
import com.csinfotechbd.utillity.DashboardHelper;
...
public class DashboardService {
    ...
    private String createRfdJpqlQuery(String unit, int queryCount, String queryStringForCard, String queryStringForLoan) {
        ...
        String card = "select new com.csinfotechbd.collection.dashboard.RfdMenuModel(" +
        ...
        String loan = "select new com.csinfotechbd.collection.dashboard.RfdMenuModel(" +
                "lower(" + queryString + ") , count(distinct lp.customerBasicInfo.id)" +
