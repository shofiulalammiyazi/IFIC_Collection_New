...
import com.csinfotechbd.letterGeneration.LetterPayload;
...
//    LoanAccountDistributionInfo findByCreatedDateIsBetweenAndLatestAndMonitoringStatus(Date startDate, Date endDate, String latest, String monitoringStatus);
    ...
    @Query(value = "" +
            "SELECT new com.csinfotechbd.letterGeneration.LetterPayload(distribution.currentOverdue,distribution.currentDpdBucket,distribution.emiAmount) FROM LoanAccountDistributionInfo distribution " +
...
//    @Query(value = " SELECT new com.csinfotechbd.collection.distribution.loan.AllocationDetails( " +
//            "LADI.dealerName , " +
//            "LADI.dealerPin, " +
//            "LADI.dpdBucket, " +
//            "count(LADI.id ) , " +
...
//
//            "FROM com.csinfotechbd.collection.distribution.loan.loanAccountDistribution.LoanAccountDistributionInfo LADI " +
