...
import com.csinfotechbd.collection.KPI.agency.card.targetByAmount.AgencyKpiTargetCardAmountSetupRepository;
import com.csinfotechbd.collection.KPI.agency.loan.targetByAccount.AgencyKpiTargetAccountSetup;
import com.csinfotechbd.collection.KPI.agency.loan.targetByAccount.AgencyKpiTargetAccountSetupRepository;
...
@Controller
@AllArgsConstructor
@RequestMapping("/collection/kpi/agency/card/bytarget/account")
public class AgencyKpiTargetCardAccountSetupController {
    private AgencyKpiTargetCardAccountSetupRepository agencyKpiTargetCardAccountSetupRepository;
    ...
    public String viewAll(Model model) {
        model.addAttribute("agencyList",agencyKpiTargetCardAccountSetupRepository.findAll());
        return "collection/kpi/agency/card/targetByAccount/list";
    }
    ...
    public String addpage(Model model) {
        ...
        model.addAttribute("agency",new AgencyKpiTargetCardAmountSetup());
        return "collection/kpi/agency/card/targetByAccount/create";
    }

    @PostMapping(value = "create")
    public String addnew(Model model, AgencyKpiTargetCardAccountSetup agency) {
        ...
        if(agency.getId()==null) {
            ...
            agencyKpiTargetCardAccountSetupRepository.save(agency);
        }else {
            agency.setModifiedBy(user.getUsername());
            agency.setModifiedDate(new Date());
            agencyKpiTargetCardAccountSetupRepository.save(agency);
        }
        return "redirect:/collection/kpi/agency/card/bytarget/account/list";
    }
    ...
    public String editPage(@RequestParam(value = "id")Long id, Model model) {
        Gson gson = new Gson();
        Gson gson1 = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create();
        AgencyKpiTargetCardAccountSetup agencyKpiTargetAmountSetup = agencyKpiTargetCardAccountSetupRepository.findById(id).get();
    ...
    public String viewPage(@RequestParam(value = "id")Long id, Model model) {
        model.addAttribute("agency",agencyKpiTargetCardAccountSetupRepository.findById(id).get());
        return "collection/kpi/agency/card/targetByAccount/view";
    }
}
