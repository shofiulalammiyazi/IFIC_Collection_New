...
@Controller
@AllArgsConstructor
@RequestMapping(value = "/collection/kpi/agency/card/bytarget/weight/account")
public class AgencyKpiTargetWeightCardAccountSetupController {
    private AgencyKpiTargetWeightCardAccountSetupRepsitory agencyKpiTargetWeightCardAccountSetupRepsitory;
    ...
    public String viewAll(Model model) {
        model.addAttribute("agencyList",agencyKpiTargetWeightCardAccountSetupRepsitory.findAll());
        return "collection/kpi/agency/card/targetByAccountWeight/list";
    }
    ...
    public String addpage(Model model) {
        ...
        model.addAttribute("agency",new AgencyKpiTargetWeightCardAccountSetup());
        return "collection/kpi/agency/card/targetByAccountWeight/create";
    }

    @PostMapping(value = "create")
    public String addnew(Model model, AgencyKpiTargetWeightCardAccountSetup agency) {
        ...
        if(agency.getId()==null) {
            ...
            agencyKpiTargetWeightCardAccountSetupRepsitory.save(agency);
        }else {
            agency.setModifiedBy(user.getUsername());
            agency.setModifiedDate(new Date());
            agencyKpiTargetWeightCardAccountSetupRepsitory.save(agency);
        }
        return "redirect:/collection/kpi/agency/card/bytarget/weight/account/list";
    }
    ...
    public String editPage(@RequestParam(value = "id")Long id, Model model) {
        Gson gson = new Gson();
        Gson gson1 = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create();
        AgencyKpiTargetWeightCardAccountSetup agencyKpiTargetAmountSetup = agencyKpiTargetWeightCardAccountSetupRepsitory.findById(id).get();
    ...
    public String viewPage(@RequestParam(value = "id")Long id, Model model) {
        model.addAttribute("agency",agencyKpiTargetWeightCardAccountSetupRepsitory.findById(id).get());
        return "collection/kpi/agency/card/targetByAccountWeight/view";
    }
}
