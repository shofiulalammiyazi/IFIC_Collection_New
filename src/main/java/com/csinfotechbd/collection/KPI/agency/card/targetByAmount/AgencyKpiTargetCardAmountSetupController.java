...
import com.csinfotechbd.collection.KPI.agency.loan.targetByAmount.AgencyKpiTargetAmountSetup;
import com.csinfotechbd.collection.KPI.agency.loan.targetByAmount.AgencyKpiTargetAmountSetupRepository;
...
@Controller
@AllArgsConstructor
@RequestMapping("/collection/kpi/agency/card/bytarget/")
public class AgencyKpiTargetCardAmountSetupController {
    private AgencyKpiTargetCardAmountSetupRepository agencyKpiTargetCardAmountSetupRepository;
    ...
    public String viewAll(Model model) {
        model.addAttribute("agencyList",agencyKpiTargetCardAmountSetupRepository.findAll());
        return "collection/kpi/agency/card/targetByAmount/list";
    }
    ...
    public String addpage(Model model) {
        ...
        return "collection/kpi/agency/card/targetByAmount/create";
    }

    @PostMapping(value = "create")
    public String addnew(Model model, AgencyKpiTargetCardAmountSetup agency) {
        ...
        if(agency.getId()==null) {
            ...
            agencyKpiTargetCardAmountSetupRepository.save(agency);
        }else {
            agency.setModifiedBy(user.getUsername());
            agency.setModifiedDate(new Date());
            agencyKpiTargetCardAmountSetupRepository.save(agency);
        }
        return "redirect:/collection/kpi/agency/card/bytarget/list";
    }
    ...
    public String editPage(@RequestParam(value = "id")Long id, Model model) {
        Gson gson = new Gson();
        Gson gson1 = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create();
        AgencyKpiTargetCardAmountSetup agencyKpiTargetAmountSetup = agencyKpiTargetCardAmountSetupRepository.findById(id).get();
    ...
    public String viewPage(@RequestParam(value = "id")Long id, Model model) {
        model.addAttribute("agency",agencyKpiTargetCardAmountSetupRepository.findById(id).get());
        return "collection/kpi/agency/card/targetByAmount/view";
    }
}
