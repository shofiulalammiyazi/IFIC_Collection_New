...
@Controller
@AllArgsConstructor
@RequestMapping(value = "/collection/dealer/card/bytarget/manager/")
public class DealerTargetCardManagerController {
    private DealerTargetCardMangerRepository dealerTargetCardMangerRepository;
    ...
    public String viewAll(Model model) {
        model.addAttribute("agencyList",dealerTargetCardMangerRepository.findAll());
        return "collection/kpi/card/targetByManager/list";
    }
    ...
    public String addpage(Model model) {
        ...
        model.addAttribute("agency",new DealerTargetCardManager());
        return "collection/kpi/card/targetByManager/create";
    }

    @PostMapping(value = "create")
    public String addnew(Model model, DealerTargetCardManager agency) {
        ...
        if(agency.getId()==null) {
            ...
            dealerTargetCardMangerRepository.save(agency);
        }else {
            agency.setModifiedBy(user.getUsername());
            agency.setModifiedDate(new Date());
            dealerTargetCardMangerRepository.save(agency);
        }
        return "redirect:/collection/dealer/card/bytarget/manager/list";
    }
    ...
    public String editPage(@RequestParam(value = "id")Long id, Model model) {
        Gson gson = new Gson();
        Gson gson1 = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create();
        DealerTargetCardManager agencyKpiTargetAmountSetup = dealerTargetCardMangerRepository.findById(id).get();
    ...
    public String viewPage(@RequestParam(value = "id")Long id, Model model) {
        model.addAttribute("agency",dealerTargetCardMangerRepository.findById(id).get());
        return "collection/kpi/card/targetByManager/view";
    }
}
